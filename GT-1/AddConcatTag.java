...
abc fgh kmln
output ='<c>abc</c>de<c>fgh</c>ijklmn'

case =2
input =keshavmemorialinstituteoftechnology
keshav memorial institute technology
output ='<c>keshavmemorialinstitute</c>of<c>technology</c>'

case =3
input =abcdefghijklm
nopqrstuv wxyz abc
output ='<c>abc</c>defghijklm'

case =4
input =abcdefghijklmnopqrstuvwxyz
no a hi cd nop
output ='<c>a</c>b<c>cd</c>efg<c>hi</c>jklm<c>nop</c>qrstuvwxyz'

case =5
input =netajisubhashchandrabose
chandra bose netaji
output ='<c>netaji</c>subhash<c>chandrabose</c>'
